 ...
 * 
 * <br/>
 * Title: Base64.java<br/>
 * E-Mail: 176291935@qq.com<br/>
 * QQ: 176291935<br/>
 * Http: iaiai.iteye.com<br/>
 * Create time: 2013-8-2 上午11:26:29<br/>
 * <br/>
 * 
 * @author 丸子
 * @version 0.0.1
...
public class Base64 {
	 ...
	 * 加密
	 */
	public static String simpleEncode(String target){
		BASE64Encoder encode = new BASE64Encoder();
		try {
			return encode.encode(target.getBytes("utf-8"));
	 ...
	 * @return
	 */
	public static String simpleDecoder(String source){
		try{
			BASE64Decoder decoder = new BASE64Decoder();
			byte[] s = decoder.decodeBuffer(source);
